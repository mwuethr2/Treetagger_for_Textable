...
#----------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    def tag(self, inputData) :
        ...
        commande1= [
        "perl",
        replace(self.lien_ttgg + "/cmd/utf8-tokenize.perl", "//","/"),
        "-f",
        "-a",
        ...
        #pas sur put etre il faut utilise deux appels a sb.Popen (A TESTER)


        print " ".join(commande1)
        output = sp.Popen(commande1, stdout=sp.PIPE)
        ...
        output = sp.Popen(commande2, stdin=out, stdout=sp.PIPE)
...
if __name__=='__main__':
    ...
    myWidget.show()
    #segmenter = Segmenter()
    myWidget.processInputData(Input("je m'appelle Chloe et je suis alcoolique."))
    myApplication.exec_()
